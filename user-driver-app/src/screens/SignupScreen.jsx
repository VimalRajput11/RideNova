...
import { Car, Mail, Lock, Eye, EyeOff, ArrowRight, User } from 'lucide-react-native';
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.title}>Join RideNova</Text>
              <Text style={styles.subtitle}>Create an account to start sharing rides.</Text>
            </View>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={styles.inputWrapper}>
                  <User size={22} color={COLORS.inputIcon} style={styles.inputIcon} />
                  <TextInput
                    style={styles.input}
              ...
              {/* Signup Button */}
              <TouchableOpacity activeOpacity={0.8} style={styles.signupBtn} onPress={() => navigation.navigate('MainTabs')}>
